...
/**
 * 1.MergerSort is a divide and conquer algorithm. 2.It divides input array in
 * two halves,keep breaking these two halves recursively until they become too
 * small to be broken further. 3.Merge each of the broken pieces together.
